...
// Declare the missing window properties
declare global {
  interface Window {
    startChat: () => void;
    sendMessage: (optional?: string) => void;
  }
}
      ...
      <BrowserRouter>
        ...
        <style>
          ...
          *{box-sizing:border-box;margin:0;padding:0;font-family:var(--font)}
          #chatToggle{
            ...
            font-size:22px;cursor:pointer;box-shadow:0 2px 8px rgba(0,0,0,.3);z-index:9999;
          }
          #chatWidget{
            ...
            transition:opacity .3s ease,transform .3s ease;z-index:9998;
          }
        ...
        <div id="chatWidget">
          ...
          <div id="preChatForm">
            ...
            <button onClick={() => window.startChat && window.startChat()}>Start Messaging</button>
          </div>
          <div className="chatBox" id="chatBox" style={{display: 'none'}}></div>
          <div className="inputBar" id="inputBar" style={{display: 'none'}}>
            <input id="chatInput" placeholder="Type your message…" />
            <button onClick={() => window.sendMessage && window.sendMessage()}>Send</button>
          </div>
        </div>
